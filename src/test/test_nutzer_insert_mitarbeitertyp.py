...
class TestNutzerInsertMitarbeitertyp(unittest.TestCase):
    ...
    def test_erfolgreicher_eintrag(self):
        ...
        # Inhalt aus Tabelle "Mitarbeitertypen" ziehen, um zu pruefen, ob der Datensatz angelegt wurde
    ...
    def test_kein_doppelter_eintrag(self):
        ...
        # Inhalt aus Tabelle "Mitarbeitertyp" ziehen, um zu pruefen, ob der Datensatz auch nur einmal angelegt wurde
