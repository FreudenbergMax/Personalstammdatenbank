...
class TestNutzerInsertWohnhaftSachsen(unittest.TestCase):
    ...
    def test_erfolgreicher_eintrag(self):
        ...
        self.testfirma.get_nutzer("M100001").\
            insert_wohnhaft_sachsen_ag_pv_beitrag('testdaten_insert_krankenversicherungsbeitraege/'
    ...
    def test_kein_doppelter_eintrag_ermaessigung(self):
        """
        Test prueft, ob bei wiederholtem Aufruf der Methode 'insert_krankenversicherungsbeitraege' mit derselben Angabe,
        ob es der ermaessigte Beitrag ist, dieser nicht mehrfach eingetragen wird. Beim zweiten Eintrag muss eine
        Exception geworfen werden. Massgeblich sit hier lediglich der boolesche Wert "ermaessigter_beitragssatz" in
        Tabelle "Krankenversicherungen". Die Exception wird auch dann geworfen, wenn die BEitragssaetze anders sind.
        Sollen nur die BEitragssaetze geaendert werden, muss hierfuer die update-Methode
